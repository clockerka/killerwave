...
const CreateAlbumPage = () => {
	...
	const handleSubmit = async (e: React.FormEvent) => {
		...
		try {
			...
			await axiosInstance.post('/artist-hub/albums', formDataToSend, {
			...
			<div className='min-h-full bg-gradient-to-b from-sky-900/20 via-zinc-900 to-zinc-900'>
				<div className='max-w-2xl mx-auto px-4 py-20'>
					...
					<div className='bg-zinc-900/50 border border-zinc-800 rounded-2xl p-8'>
						<h1 className='text-3xl font-bold text-white mb-6'>create new album</h1>
									...
									<div
										...
										>
											...
											<p className='text-sm text-zinc-500'>
												png, jpg up to 10mb (square recommended)
											</p>
										</div>
									)}
									<input
